<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucVideo.ascx.cs" Inherits="Admin_usercontrols_ucVideo" %>
    ...
    <div class="container">
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            <ContentTemplate>
                ...
                <div class="box-header">
                    <div style="text-align: left">
                        ...
                        <asp:Button ID="btnMoveVideo" runat="server" CausesValidation="False" CssClass="button"
                            OnClientClick="if(!IsEdit('chckSelect','notselect')) return; showClose=true;isMoveVideo=true;"
                ...
                <div class="box table">
                    ...
                    <asp:GridView ID="gvData" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        CellPadding="0" CssClass="GridStyle" DataKeyNames="VideoID" DataSourceID="ObjData"
                    ...
                    <asp:ObjectDataSource ID="ObjData" runat="server" EnablePaging="True" MaximumRowsParameterName="maximumRows"
                        OnObjectCreating="ObjDataObjectCreating" SelectCountMethod="GetAllVideoRowCount"
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="btnMoveVideo" />
            </Triggers>
        </asp:UpdatePanel>
        <div id="divMoveVideo" class="popup" style="display: none">
                        ...
                        <tr>
                            ...
                            <td class="miditem">
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            <asp:Label ID="lblVideoType" CssClass="Caption" runat="server" Text="Chuyển tin đã chọn sang"></asp:Label>
                                        </td>
                                        <td class="td1empty">
                                        </td>
                                        <td class="Require">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:CompareValidator ID="cvVideoTypeMove" runat="server" ValidationGroup="vMove"
                                                ControlToValidate="drVideoTypeMove" ErrorMessage="" Display="Dynamic" Operator="NotEqual"
