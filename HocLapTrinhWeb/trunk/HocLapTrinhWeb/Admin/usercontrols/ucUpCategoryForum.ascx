<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucUpCategoryForum.ascx.cs"
    Inherits="Admin_usercontrols_ucUpCategoryForum" %>
            ...
            <ContentTemplate>
                ...
                <div class="box table">
                    <asp:GridView CellPadding="0" Width="100%" CssClass="GridStyle" AutoGenerateColumns="False"
                        AllowPaging="True" DataKeyNames="CategoryForumID" DataSourceID="ObjData" ID="gvData"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="LinkPost" SortExpression="LinkPost">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hpLinkPost" runat="server" Text='<%# Eval("LinkPost") %>'></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="CategoryName" SortExpression="CategoryName">
                                <ItemTemplate>
                                    <asp:HiddenField ID="hdCategoryForumID" Value='<%# Eval("CategoryForumID") %>' runat="server" />
                                    <asp:HyperLink ID="hpUserName" runat="server" Text='<%# Eval("CategoryName") %>'></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Description" SortExpression="Description">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hpDescription" runat="server" Text='<%# Eval("Description") %>'></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:ObjectDataSource ID="ObjData" runat="server" TypeName="HocLapTrinhWeb.BLL.vnn_UpCategoryForumBLL"
                        EnablePaging="True" SelectMethod="GetAllCategoryForumForGridView" SelectCountMethod="GetAllCategoryForumRowCount"
                        ...
                        <tr>
                            ...
                            <td class="miditem">
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            <asp:Label ID="Label1" runat="server" CssClass="Caption" Text="Tên chuyên mục"></asp:Label>
                                        </td>
                                        <td>
                                        </td>
                                        <td class="Require">
                                    ...
                                    <tr valign="top">
                                        <td>
                                            <asp:Label ID="lblCategoryForumName" CssClass="Caption" runat="server" Text="Tên diễn đàn"></asp:Label>
                                        </td>
                                        <td class="tdempty">
                                        </td>
                                        <td class="Require">
                                        ...
                                        <td>
                                            <asp:DropDownList class="editable-select" ID="dropForum" runat="server" AutoPostBack="False"
                                                DataSourceID="ObjForum" DataTextField="ForumName" DataValueField="ForumID" OnDataBound="DropForumDataBound">
                                            </asp:DropDownList>&nbsp;
                                            <asp:HiddenField ID="hdForum" runat="server" />
                                            <asp:ObjectDataSource ID="ObjForum" runat="server" OnObjectCreating="ObjForumObjectCreating"
                                                SelectMethod="GetAllForumForGridView" TypeName="HocLapTrinhWeb.BLL.vnn_UpForumBLL">
                                            </asp:ObjectDataSource>
                                        </td>
                                    </tr>
                                    <tr class="trEmpty">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label2" CssClass="Caption" runat="server" Text="Link Post"></asp:Label>
                                        </td>
                                        <td class="tdempty">
                                        </td>
                                        <td class="Require">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtLinkPost" runat="server" Width="400"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
                                        ...
                                        <td>
                                            <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ErrorMessage="Phải nhập"
                                                Display="Dynamic" ValidationGroup="vAdd" ControlToValidate="txtLinkPost" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr class="trEmpty">
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label3" CssClass="Caption" runat="server" Text="Ghi chú"></asp:Label>
                                        </td>
                                        <td class="tdempty">
                                        </td>
                                        <td class="Require">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtDescription" runat="server" Width="400" Height="100px" TextMode="MultiLine"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr class="trEmpty">
                                    </tr>
...
<script type="text/javascript">
        ...
        function CheckValue()
        {
             ...
             $('#<%= hdForum.ClientID %>').val($('.<%= dropForum.ClientID %>')[0].value);
        }
        ...
        { 
            if(isAdd)
            {
                    showPopupDiv('divAdd','Thêm CategoryForum', null, null, true,null,null,'absolute');//absolute
                    isAdd=false;
            }
             if(isEdit)
            {
                    showPopupDiv('divAdd','Sửa thông tin CategoryForum', null, null, true,null,null,'absolute');
                    isEdit=false;
            }
