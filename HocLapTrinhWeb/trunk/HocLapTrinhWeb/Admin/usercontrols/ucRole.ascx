<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucRole.ascx.cs" Inherits="dhadmincp_usercontrols_ucRole" %>
            ...
            <ContentTemplate>
                ...
                <div class="box table">
                    <asp:GridView CellPadding="0" Width="100%" CssClass="GridStyle" AutoGenerateColumns="False"
                        AllowPaging="True" DataKeyNames="RoleID" DataSourceID="ObjData" ID="gvData" runat="server"
        ...
        <div id="divAdd" class="popup" style="display: none">
            <asp:UpdatePanel ID="updatepanel2" runat="server">
                <ContentTemplate>
                    ...
                    <asp:HiddenField runat="server" ID="hdRoleID" Value="0" />
                    <table cellpadding="3">
                        <tr>
                            <td class="midleft">
                            </td>
                            <td class="miditem">
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            <asp:Label ID="lblUserName" CssClass="Caption" runat="server" Text="Role"></asp:Label>
                                        </td>
                                        <td class="tdempty">
                                        </td>
                                        <td class="Require">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtRole" runat="server" Width="300px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
                                        ...
                                        <td>
                                            <asp:RequiredFieldValidator ID="rfvUserName" runat="server" ErrorMessage="Nhập Role"
                                                Display="Dynamic" ValidationGroup="vAdd" ControlToValidate="txtRole" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr class="trEmpty">
                                    </tr>
