...
<asp:UpdateProgress ID="upProgcess" DisplayAfter="10" runat="server">
    <ProgressTemplate>
        <div style="position: absolute; width: 100%; height: 100%; z-index: 200; background-color: #ffffff; opacity: 0.65; filter: alpha(opacity=65)">
...
<div id="login-wrapper">
    <div class="box-header login">
        <asp:HyperLink ID="hpHeaderLogin" runat="server" NavigateUrl="~/default.aspx" Text="Đăng Nhập - HocLapTrinhWeb.com"></asp:HyperLink>
    </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" CssClass="Caption" Text="Mã bảo vệ"></asp:Label>
                        </td>
                        <td class="tdEmpty"></td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="Caption" Text="Nhập mã bảo vệ"></asp:Label>
                        </td>
                        <td class="tdEmpty"></td>
                        <td>
                              <asp:TextBox ID="txtImgVerify" runat="server" Style="padding: 5px; width: 190px;" ToolTip="Nhập mã bảo vệ"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        ...
                        <td>
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtImgVerify"
                            Display="Dynamic" ErrorMessage="Phải nhập" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr class="trEmpty">
                        <td></td>
