            ...
            <li class="<%= SetClass("admin/News.aspx","admin/UpdateNews.aspx","admin/NewsType.aspx")  %>">
                ...
                <ul style="display: block" class="<%= "sub " + IsShow("admin/News.aspx","admin/UpdateNews.aspx","admin/NewsType.aspx") %>">
                    <li class="<%= SetClass("admin/NewsType.aspx")  %>">
                        <asp:HyperLink ID="HyperLink2" class="icn_news" runat="server" NavigateUrl="~/admin/NewsType.aspx"
                            Text="Loại Tin"></asp:HyperLink></li>
                    <li class="<%= SetClass("admin/Tag.aspx")  %>">
                        <asp:HyperLink ID="HyperLink9" class="icn_news" runat="server" NavigateUrl="~/admin/Tag.aspx"
                            Text="Tag"></asp:HyperLink></li>
                    <li class="<%= SetClass("admin/UpdateNews.aspx")  %>">
                        <asp:HyperLink ID="HyperLink10" class="icn_news" runat="server" NavigateUrl="~/admin/UpdateNews.aspx"
                            Text="Lấy tin tự động"></asp:HyperLink></li>
                </ul>
            </li>
            <li class="<%= SetClass("admin/Alexa.aspx")  %>">
                <asp:HyperLink ID="HyperLink11" class="icn_news" runat="server" NavigateUrl="~/admin/Alexa.aspx"
                    Text="Site Alexa"></asp:HyperLink></li>
            <li class="<%= SetClass("admin/SeoConfig.aspx")  %>">
                <asp:HyperLink ID="hpContact1" class="icn_news" runat="server" NavigateUrl="~/admin/SeoConfig.aspx"
                    Text="Site SeoConfig"></asp:HyperLink></li>
            <li class="<%= SetClass("admin/Contact.aspx")  %>">
                <asp:HyperLink ID="hpContact" class="icn_news" runat="server" NavigateUrl="~/admin/Contact.aspx"
                    Text="Liên hệ"></asp:HyperLink></li>
            <li class="<%= SetClass("admin/CommentNews.aspx")  %>">
                <asp:HyperLink ID="hpCommemnt" class="icn_news" runat="server" NavigateUrl="~/admin/CommentNews.aspx"
                    Text="Bình luận"></asp:HyperLink></li>
            <li class="<%= SetClass("admin/User.aspx")  %>">
                <asp:HyperLink ID="hpUser" class="icn_news" runat="server" NavigateUrl="~/admin/User.aspx"
                    Text="Thành viên"></asp:HyperLink></li>
            <li class="<%= SetClass("admin/AutoAdv.aspx")  %>">
                <asp:HyperLink ID="hpAutoAdv" class="icn_news" runat="server" NavigateUrl="~/admin/AutoAdv.aspx"
