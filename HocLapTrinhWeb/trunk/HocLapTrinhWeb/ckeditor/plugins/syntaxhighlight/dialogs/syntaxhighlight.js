...
CKEDITOR.dialog.add("syntaxhighlight", function (c) {
    ...
    var dt = function (g) {
        var f = "";
        if (g.codeTitleChecked && g.codeTitle != "") {
            f += g.codeTitle;
        }
        return f;
    };
                        ...
                        children: [
                            {
                                ...
                                "default": "xml",
                                widths: ["25%", "75%"],
                                items: [["Bash (Shell)", "bash"], ["CSS", "css"], ["HTML/XML", "xml"], ["Javascript", "jscript"], ["PHP", "php"], ["Plain (Text)", "plain"], ["SQL", "sql"], ["C#", "csharp"]],
                                setup: function (f) {
                                    if (f.lang) {
                                ...
                                children: [
                                    {
                                        ...
                                        id: "ct_toggle",
                                        label: "",
                                        setup: function (f) { this.setValue(f.codeTitleChecked); },
                                        commit: function (f) { f.codeTitleChecked = this.getValue(); }
                                    },
                                    {
                                        type: "text",
                                        id: "default_ti",
                                        ...
                                        setup: function (f) {
                                            if (f.codeTitle != "") {
                                                this.setValue(f.codeTitle);
                                            }
                                        },
                                        commit: function (f) {
                                            if (this.getValue() && this.getValue() != "") {
                                                f.codeTitle = this.getValue();
                                            }
                                        }
                                    }
                                ]
                                ...
                                children: [
                                    {
                                        ...
                                        id: "lc_toggle",
                                        label: "",
                                        setup: function (f) { this.setValue(f.firstLineChecked); },
                                        commit: function (f) { f.firstLineChecked = this.getValue(); }
                                    },
                                    {
                                        type: "text",
                                        id: "default_lc",
                                ...
                                children: [
                                    {
                                        ...
                                        id: "hl_toggle",
                                        label: "",
                                        setup: function (f) { this.setValue(f.highlightChecked); },
                                        commit: function (f) { f.highlightChecked = this.getValue(); }
                                    },
                                    {
                                        type: "text",
                                        id: "default_hl",
