...
public partial class LinkBrowserPage : Page
{
    ...
    {
        LinkFolder = "";
        var directories = Directory.GetDirectories(FileLinkFolder);
    ...
    {
        var name = UniqueDirectory(NewDirectoryName.Value);
    ...
    protected void BindImageList()
    {
        ...
        var files = Directory.GetFiles(FileLinkFolder, "*" + SearchTerms.Text.Replace(" ", "*") + "*");
    ...
    {
        var pos = ImageList.SelectedValue.LastIndexOf('.');
        if (pos == -1)
            return;
        ...
        var link = LinkFolder + ImageList.SelectedValue;
    ...
    protected string UniqueFilename(string filename)
    {
        ...
        for (var i = 1; File.Exists(FileLinkFolder + newfilename); i++)
        {
    ...
    protected string UniqueDirectory(string directoryname)
    {
        ...
        for (var i = 1; Directory.Exists(FileLinkFolderRoot + newdirectoryname); i++)
