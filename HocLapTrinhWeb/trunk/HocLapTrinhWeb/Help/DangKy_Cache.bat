...
aspnet_regsql.exe -S VONHATNAM-PC\SQLServerR2 -U sa -P vnn123456 -d HocLapTrinhWeb.com -t tbl_Video -et
aspnet_regsql.exe -S VONHATNAM-PC\SQLServerR2 -U sa -P vnn123456 -d HocLapTrinhWeb.com -t tbl_VideoType -et
