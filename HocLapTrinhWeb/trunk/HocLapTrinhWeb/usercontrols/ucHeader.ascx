        ...
        <div class="top_ad ads360">
            <div id="ddtopmenubar" class="mattblackmenu">
                <ul>
                    ...
                    <li><a href="http://forum.hoclaptrinhweb.com" class="bgreen"><i class="fa fa-comments"></i>Diễn đàn</a></li>
                    <li><a href="<%= CurrentPage.UrlRoot %>/contact.aspx" class="bblue"><i class="fa fa-envelope-o"></i>Liên hệ</a></li>
                    <li><a href="http://m.hoclaptrinhweb.com" class="bviolet selected"><i class="fa fa-tablet"></i>Mobile</a>
                    </li>
                </ul>
            </div>
        </div>
