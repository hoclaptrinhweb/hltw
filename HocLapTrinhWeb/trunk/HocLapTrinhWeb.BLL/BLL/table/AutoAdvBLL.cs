...
{
    public class AutoAdvBLL : ClassBase
    {
        #region Variable
        ...
        public AutoAdvBLL(Connection conn)
        {
            IConnect = conn;
        }

        public dsHocLapTrinhWeb.tbl_AutoAdvRow GetAutoAdvByID(int id)
        {
            var isOpen = false;
            try
            {
                if (OpenConnection(ref isOpen))
                {
                    ...
                    _classBaseDAL = new ClassBaseDAL(IConnect, dt) { WhereClause = dt.AutoAdvIDColumn.ColumnName + "=@id" };
        ...
        public dsHocLapTrinhWeb.tbl_AutoAdvRow GetAutoAdvByDate(string strdate, int type)
        {
            var isOpen = false;
            try
            {
                if (OpenConnection(ref isOpen))
                {
                    ...
                    if(type != -1)
                    {
                        _classBaseDAL.WhereClause += (_classBaseDAL.WhereClause == null ? "" : " and ") + dt.TypeIDColumn.ColumnName + "=@type";
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public bool Add(dsHocLapTrinhWeb.tbl_AutoAdvDataTable dt)
        {
            var isOpen = false;
            try
            {
                if (OpenConnection(ref isOpen))
                {
                    _classBaseDAL = new ClassBaseDAL(IConnect, dt);
                    dt.AcceptChanges();
                    foreach (dsHocLapTrinhWeb.tbl_AutoAdvRow row in dt.Rows)
                        row.SetAdded();
        ...
        public bool Update(dsHocLapTrinhWeb.tbl_AutoAdvDataTable dt)
        {
            var isOpen = false;
            try
            {
        ...
        public bool Update(dsHocLapTrinhWeb.tbl_AutoAdvDataTable dt,params string[] columnsName)
        {
            var isOpen = false;
            try
            {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public bool Delete(dsHocLapTrinhWeb.tbl_AutoAdvDataTable dt)
        {
            var isOpen = false;
            try
            {
        ...
        public bool Delete(int id)
        {
            ...
            try
            {
                if (OpenConnection(ref isOpen))
                {
                    ...
                    _classBaseDAL = new ClassBaseDAL(IConnect, dt);
                    _classBaseDAL.ClearParams();
                    _classBaseDAL.WhereClause = dt.AutoAdvIDColumn.ColumnName + "=@1";
        ...
        public bool Delete(ArrayList arrayID)
        {
            ...
            try
            {
                if (OpenConnection(ref isOpen))
                {
                    ...
                    _classBaseDAL = new ClassBaseDAL(IConnect, dt);
                    _classBaseDAL.ClearParams();
                    string strWhereClause = dt.AutoAdvIDColumn.ColumnName + " in (";
