...
{
    public class UpUserBLL : ClassBase
    {
        #region Variable
        ...
        public UpUserBLL(Connection conn)
        {
            IConnect = conn;
        }

        public dsHocLapTrinhWeb.up_tbl_UserRow GetUserByID(int id)
        {
            var isOpen = false;
            try
            {
        ...
        public dsHocLapTrinhWeb.up_tbl_UserRow GetUserByName(string name)
        {
            var isOpen = false;
            try
            {
                ...
                {
                    var dt = new dsHocLapTrinhWeb.up_tbl_UserDataTable();
                    _classBaseDAL = new ClassBaseDAL(IConnect, dt) { WhereClause = dt.UserNameColumn.ColumnName + "=@Name" };
                    _classBaseDAL.ClearParams();
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public bool Add(dsHocLapTrinhWeb.up_tbl_UserDataTable dt)
        {
            bool isOpen = false;
            try
            {
                if (OpenConnection(ref isOpen))
                {
                    ...
                    dt.AcceptChanges();
                    foreach (dsHocLapTrinhWeb.up_tbl_UserRow row in dt.Rows)
                        row.SetAdded();
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public bool Update(dsHocLapTrinhWeb.up_tbl_UserDataTable dt)
        {
            bool isOpen = false;
            try
            {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public bool Delete(dsHocLapTrinhWeb.up_tbl_UserDataTable dt)
        {
            bool isOpen = false;
            try
            {
