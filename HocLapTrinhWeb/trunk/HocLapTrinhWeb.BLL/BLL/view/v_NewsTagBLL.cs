...
{
    public class v_NewsTagBLL : t_NewsTagBLL
    {
        #region Variable
        ...
        public v_NewsTagBLL(Connection conn): base(conn)
        {

        }

        /// <summary>
        /// Load NewsTag len gridview
        /// </summary>
        /// <param name="startRowIndex"></param>
        /// <param name="maximumRows"></param>
        /// <returns></returns>
        public vnn_dsHocLapTrinhWeb.vnn_vw_NewsTagDataTable GetAllNewsTagForGridView(int startRowIndex, int maximumRows)
        {
            var isOpen = false;
            try
            {
                ...
                {
                    var dt = new vnn_dsHocLapTrinhWeb.vnn_vw_NewsTagDataTable();
                    _ClassBaseDAL = new ClassBaseDAL(IConnect, dt)
                        {
                            StartRow = startRowIndex,
                            MaxRows = maximumRows,
                            OrderByClause = dt.NewsTagIDColumn.ColumnName + " desc"
                        };
        ...
        /// </summary>
        /// <returns></returns>
        public int GetAllNewsTagRowCount()
        {
            var isOpen = false;
            try
            {
